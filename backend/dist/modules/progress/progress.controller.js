...
exports.getSubjectProgress = exports.updateVideoProgress = exports.getVideoProgress = void 0;
...
const updateVideoProgress = async (req, res, next) => {
    try {
        ...
        const progress = await progressService.upsertVideoProgress(req.user.userId, req.params.videoId, position);
        res.status(200).json({ success: true, data: progress });
    }
    catch (error) {
        next(error);
